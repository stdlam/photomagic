...
public final class BezierSpline {
     ...
     */
    public static int[] curveGenerator(Point[] knots) throws RuntimeException {
        if (knots == null) {
    ...
    private static int[] getOutputPointsForNewerDevices(Point[] knots) throws RuntimeException {
