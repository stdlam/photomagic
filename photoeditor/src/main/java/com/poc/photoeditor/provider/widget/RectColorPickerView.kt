...
class RectColorPickerView(context: Context, attributeSet: AttributeSet?) :
    ...
    init {
        ...
        linePaint.pathEffect = CornerPathEffect(40f)
    ...
    override fun initializeSliderPaint() {
        ...
        darknessShader =
            LinearGradient(
                ...
                heightF,
                Color.TRANSPARENT,
                ResourcesCompat.getColor(resources, R.color.black_60, null),
                Shader.TileMode.MIRROR
            )
